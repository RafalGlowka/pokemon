...
import com.glowka.rafal.pokemon.presentation.flow.dashboard.details.DetailsScreenStructure
import com.glowka.rafal.pokemon.presentation.flow.dashboard.details.DetailsViewModelToFlowInterface
import com.glowka.rafal.pokemon.presentation.flow.dashboard.list.ListScreenStructure
...
interface DashboardFlow : Flow<EmptyParam, DashboardResult> {
  ...
  sealed class Screens<PARAM : Any, EVENT : ScreenEvent,
    ...
    object List : Screens<EmptyParam, ListViewModelToFlowInterface.Event, ListViewModelToFlowInterface>(
      ListScreenStructure
    )
    object Details : Screens<DetailsViewModelToFlowInterface.Param, DetailsViewModelToFlowInterface.Event, DetailsViewModelToFlowInterface>(
