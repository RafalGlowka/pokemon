package com.glowka.rafal.pokemon.presentation.binding
...
import com.glowka.rafal.pokemon.presentation.binding.fields.ProgressPosition
...
fun ImageView.loadImage(image: ImageModel) {
  ...
  image.url?.let { imageUrl ->
    ...
    if (image.fallbackImageResId != 0) {
      glide.fallback(image.fallbackImageResId)
      glide.error(image.fallbackImageResId)
    }
    glide.into(this)
  } ?: if (image.fallbackImageResId != 0) {
